...
% Canonical pandoc metadata lives in md2pdfLib/pandoc/base.yml
% Use \providecommand so these can be overridden from the preamble.
...
\providecommand{\reviewertwo}{Johannes Heinle}
\providecommand{\submissiontime}{22.05.2023}
...
% ----------------------------------------------------------------
% Printer-friendly code blocks (Pandoc fenced code):
% - light background (good for printing)
% - rounded corners
% - colored frame
% Pandoc emits: \begin{Shaded}\begin{Highlighting}...\end{Highlighting}\end{Shaded}
% The box itself is the shared brand code frame; only print-specific knobs live
% here: a thinner rule, tighter padding, and a forced-light background even if
% a dark highlight theme sneaks in -- this document prints.
