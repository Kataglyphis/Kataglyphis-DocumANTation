...
% The highlight theme defines the Shaded env; we override it at begin-document.
\tcbuselibrary{breakable,skins}
\AtBeginDocument{%
	\colorlet{shadecolor}{black!2}% enforce a light background even if a dark theme is used
	\ifdefined\Shaded
