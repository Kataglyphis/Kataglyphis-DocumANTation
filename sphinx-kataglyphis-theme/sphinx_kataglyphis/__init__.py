...
def _scaffold(dest: Path) -> None:
    ...
    if conf_py.exists():
        ...
        conf_py.write_text(
            f'# Sphinx config — auto-generated by sphinx-kataglyphis\n'
            f'import sys\n'
            f'from pathlib import Path\n'
            f'sys.path.insert(0, str(Path(__file__).resolve().parent.parent /\n'
            f'                         "sphinx-kataglyphis-theme"))\n'
            f'from sphinx_kataglyphis import setup_theme\n'
            f'setup_theme(globals(),\n'
            f'    auto_discover=True,\n'
            f'    repository_url="https://github.com/org/repo",\n'
            f'    project_name="My Project",\n'
            f'    copyright_="2025, You",\n'
            f'    author="You",\n'
            f'    release="0.1.0",\n'
            f')\n',
            encoding="utf-8",
    ...
    print(f"    3. Open _build/html/index.html")
